...
export default class SmokeWeapon extends BaseWeapon {
    static upgrades = [
        {damage: 0.2, slowness: 0.3, time: 1000, firerate: 5000, range: 70, price: 150}, // initial buy price
        {damage: 0, slowness: 0.5, time: 2000, firerate: 5000, range: 80, price: 100},
        {damage: 0, slowness: 0.5, time: 3000, firerate: 3000, range: 80, price: 100},
        {damage: 0.2, slowness: 0.6, time: 4000, firerate: 3000, range: 100, price: 300},
        {damage: 0.4, slowness: 0.6, time: 5000, firerate: 3000, range: 100, price: 500}
    ]
